...
{
    public partial class PlayerInfoListVM : BasePagedListVM<PlayerInfo_View, PlayerInfoSearcher>
    {
        ...
        protected override IEnumerable<IGridColumn<PlayerInfo_View>> InitGridHeader()
        {
            return new List<GridColumn<PlayerInfo_View>>{
        ...
        public override IOrderedQueryable<PlayerInfo_View> GetSearchQuery()
        {
    ...
    public class PlayerInfo_View : PlayerInfo{
