...
{
    public partial class PlayerAttributeListVM : BasePagedListVM<PlayerAttribute_View, PlayerAttributeSearcher>
    {
        ...
        protected override IEnumerable<IGridColumn<PlayerAttribute_View>> InitGridHeader()
        {
            return new List<GridColumn<PlayerAttribute_View>>{
        ...
        public override IOrderedQueryable<PlayerAttribute_View> GetSearchQuery()
        {
            var query = DC.Set<PlayerAttribute>()
                ...
                .Select(x => new PlayerAttribute_View
                {
				    ID = x.ID,
    ...
    public class PlayerAttribute_View : PlayerAttribute{
