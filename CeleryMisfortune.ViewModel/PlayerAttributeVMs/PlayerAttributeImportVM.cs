...
{
    public partial class PlayerAttributeTemplateVM : BaseTemplateVM
    {
        [Display(Name = "关联角色ID")]
    ...
    public class PlayerAttributeImportVM : BaseImportVM<PlayerAttributeTemplateVM, PlayerAttribute>
    {
