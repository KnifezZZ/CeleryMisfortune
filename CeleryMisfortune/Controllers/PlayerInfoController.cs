...
namespace CeleryMisfortune.Controllers
{
    ...
    public partial class PlayerInfoController : BaseController
    {
        ...
        {
            var vm = CreateVM<PlayerInfoListVM>();
            return PartialView(vm);
        }

        [ActionDescription("搜索")]
        [HttpPost]
        public string Search(PlayerInfoListVM vm)
        {
        ...
        {
            var vm = CreateVM<PlayerInfoVM>(id);
            return PartialView(vm);
        }
        ...
        {
            var vm = CreateVM<PlayerInfoBatchVM>(Ids: IDs);
            return PartialView(vm);
        }

        [HttpPost]
        [ActionDescription("批量修改")]
        public ActionResult DoBatchEdit(PlayerInfoBatchVM vm, IFormCollection nouse)
        {
        ...
        [HttpPost]
        [ActionDescription("批量删除")]
        public ActionResult DoBatchDelete(PlayerInfoBatchVM vm, IFormCollection nouse)
        {
        ...
        {
            var vm = CreateVM<PlayerInfoImportVM>();
            return PartialView(vm);
        }

        [HttpPost]
        [ActionDescription("导入")]
        public ActionResult Import(PlayerInfoImportVM vm, IFormCollection nouse)
        {
        ...
        [HttpPost]
        public IActionResult ExportExcel(PlayerInfoListVM vm)
        {
